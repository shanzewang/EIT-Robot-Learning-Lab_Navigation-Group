...
class StageWorld:
    def __init__(self, beam_num):
        ...
        for map_no in range(7):
            self.map_sizes[map_no, 0] = 15.0 * (0.8**map_no)
            self.map_sizes[map_no, 1] = 15.0 * (0.8**map_no)
    ...
    def step(
        ...
        return state, reward, terminate, goal_reach, reset, self.distance, [x, y, theta]
